	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			for (Instance instance : instances) {
				if(instance.getState().getName().equalsIgnoreCase("stopped") || instance.getState().getName().equalsIgnoreCase("stopping")) {
					TerminateInstancesRequest terminateInstancesRequest = new TerminateInstancesRequest();
					terminateInstancesRequest.withInstanceIds(instance.getInstanceId());
					ec2.terminateInstances(terminateInstancesRequest );
					System.out.println("You have the instance with instance id : " + instance.getInstanceId() + " terminated");
				}
			}
